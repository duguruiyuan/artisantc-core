...
/**
 * 支持“MyBlock”JPA操作的条件设置。
 * Created by xinjie.li on 2016/9/19.
 *
 * @author xinjie.li
 * @since 1.0
 */
public class MyBlockSpecification {
     ...
     * @return
     */
    public static Specification<MyBlock> findAllByMomentId(final long userId) {
        return new Specification<MyBlock>() {
            @Override
            public Predicate toPredicate(Root<MyBlock> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
