...
@Service
@Transactional
public class ArtMomentServiceImpl extends AbstractMomentService implements ArtMomentService {

    @Autowired
    public ArtMomentServiceImpl(ArtMomentRepository artMomentRepository, UserRepository userRepository,
    ...
    public ArtMomentView post(String content, MultipartFile[] files, String location, String primaryTagName, String[] secondaryTagNames) {
        return super.postMoment(content, files, location, BaseMoment.Category.ART, primaryTagName, secondaryTagNames);
    }

    @Override
    public ArtMomentView forward(String content, String momentId, String location) {
        return super.forwardMoment(content, momentId, location, BaseMoment.Category.ART);
    }

    @Override
    public ArtMomentViewPaginationList findByPage(int page) {
        return super.findByCategoryAndStatusAndPage(BaseMoment.Category.ART, BaseMoment.Status.AVAILABLE, page);
    }

    @Override
    public ArtMomentView findById(String momentId) {
        return super.findOneByCategory(momentId, BaseMoment.Category.ART);
    }

    @Override
    public ArtMomentCommentView commentOn(String momentId, String parentCommentId, String comment) {
        return super.commentOnMoment(momentId, parentCommentId, comment, BaseMoment.Category.ART);
    }

    @Override
    public ArtMomentGiveLikeSummaryView giveLikeOnMomentList(String momentId) {
        return super.giveLikeForMomentList(momentId, BaseMoment.Category.ART);
    }

    @Override
    public ArtMomentGiveLikeSummaryView giveLikeOnMomentDetail(String momentId) {
        return super.giveLikeForMomentDetail(momentId, BaseMoment.Category.ART);
    }

    @Override
    public ArtMomentLikesViewPaginationList findLikesByMomentId(String momentId, int page) {
        return super.findLikesByMomentIdAndPage(momentId, BaseMoment.Category.ART, page);
    }

    @Override
    public ArtMomentCommentViewPaginationList findCommentsByMomentId(String momentId, int page) {
        return super.findCommentsByMomentIdAndPage(momentId, BaseMoment.Category.ART, page);
    }

    @Override
    public ArtMomentViewPaginationList findMyArtMomentsByPage(int page) {
        return super.findMyArtMomentsByPage(page);
    }

    @Override
    public ArtMomentViewPaginationList findArtMomentsBySerialNumberAndPage(String serialNumber, int page) {
        return super.findArtMomentsBySerialNumberAndPage(serialNumber, page);
    }

    @Override
    public void deleteByMomentId(String momentId) {
        super.deleteByMomentId(momentId);
    }

    @Override
    public ArtMomentViewPaginationList getMomentsByMyFollows(int page) {
        return super.findByMyFollows(BaseMoment.Category.ART, BaseMoment.Status.AVAILABLE, page);
    }

    @Override
    public ArtMomentRewardViewPaginationList findUserRewardOrdersByMomentId(String momentId, int page) {
        return super.findUserRewardOrdersByMomentId(momentId, BaseMoment.Category.ART, BaseMoment.Status.AVAILABLE, page);
    }

    @Override
    public ArtMomentCommentGiveLikeSummaryView giveLikeOnArtMomentComment(String momentId, String commentId) {
        return super.giveLikeOnMomentComment(momentId, commentId, BaseMoment.Category.ART, BaseMoment.Status.AVAILABLE);
    }
}
