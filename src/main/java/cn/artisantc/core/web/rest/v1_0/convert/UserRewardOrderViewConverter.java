...
/**
 * “UserRewardOrder”转“UserRewardOrderView”的转换器。
 * Created by xinjie.li on 2017/3/1.
 *
 * @author xinjie.li
 * @since 2.5
 */
public class UserRewardOrderViewConverter implements Converter<UserRewardOrder, UserRewardOrderView> {

    private MessageSource messageSource;

    public UserRewardOrderViewConverter(MessageSource messageSource) {
        this.messageSource = messageSource;
    }

    @Override
    public UserRewardOrderView convert(UserRewardOrder source) {
        UserRewardOrderView view = new UserRewardOrderView();
        ...
        calendar.setTimeInMillis(createDateTime.getTime() + PaymentConstant.TIMEOUT_MILLIS_USER_REWARD_ORDER);// 需要在订单创建时间上加上超时时间，再进行倒计时的计算
