...
<head>
    ...
    <title><fmt:message key="text.page.suggestion"/> - <fmt:message key="text.page.head.title"/></title>
...
<div class="container" role="main">
    ...
    <div class="col-sm-11 col-md-11 col-lg-11 page-header">
        <h1><fmt:message key="text.page.suggestion"/>
...
<script>
    ...
    /* 分页列表功能 */
    var pageHref = "<c:url value='/administrator/suggestions' />";
    ...
    function getListSuccessCallback(data, textStatus, jqXHR) {
        ...
        $.each(data.suggestions, function () {
            ...
            var $appendData = $("<div class=\"thumbnail img-cover\">" +
                    <%--"<a href=\"<c:url value="/console/suggestions/"/>" + this.suggestionId + "\" target=\"_blank\">" +--%>
                    "<a href=\"#\">" +
                    "<div class=\"caption\">" +
                    "<p>" + this.content + "</p>" +
                    "<p class=\"pull-right\">" + this.createDateTime + "</p>" +
                    "</div>" +
                    "</a>" +
                    "</div>");
