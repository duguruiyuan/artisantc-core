...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="create-modal-label"><fmt:message key="text.label.art.big.shot.create"/></h4>
</div>

<div class="modal-body">
    <form id="artBigShotForm" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <input class="form-control" name="overview" type="text" placeholder="大咖的一句话简介" required="required" autofocus="autofocus">
        </div>
        <div class="form-group">
            <textarea class="form-control" name="introduce" placeholder="大咖的详细介绍" rows="7" required="required"></textarea>
        </div>
    </form>
</div>
