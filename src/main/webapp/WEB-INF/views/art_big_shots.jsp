...
<head>
    ...
    <title><fmt:message key="text.page.art.big.shots"/> - <fmt:message key="text.page.head.title"/></title>
...
<div class="container" role="main">
    ...
    <div class="col-sm-11 col-md-11 col-lg-11 page-header">
        <h1><fmt:message key="text.page.art.big.shots"/>
...
<script>
    ...
    /* 分页列表功能 */
    var pageHref = "/administrator/art-big-shots";// 分页数据的URL
    ...
    function getListSuccessCallback(data, textStatus, jqXHR) {
        ...
        $.each(data.artBigShots, function () {
            // “个人头像”
            var avatar = "";
            ...
            var $appendData = $("<div class=\"thumbnail img-cover\">" +
                "<a href=\"<c:url value="/console/art-big-shots/"/>" + this.artBigShotId + "\" target=\"_blank\" title=\"" + this.nickname + "\">" +
                avatar +
                "<div class=\"caption\">" +
