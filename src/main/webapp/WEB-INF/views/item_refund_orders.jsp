...
<head>
    ...
    <title><fmt:message key="text.page.item.refund.orders"/> - <fmt:message key="text.page.head.title"/></title>
...
<div class="container" role="main">
    ...
    <div class="col-sm-11 col-md-11 col-lg-11 page-header">
        <h1><fmt:message key="text.page.item.refund.orders"/>
...
<script>
    ...
    /* 分页列表功能 */
    var pageHref = "<c:url value='/administrator/item-refund-orders' />";
    ...
    function getListSuccessCallback(data, textStatus, jqXHR) {
        ...
        $.each(data.itemPaymentOrders, function () {
            ...
            var $appendData = $("<div class=\"thumbnail img-cover\">" +
                    "<a href=\"<c:url value="/console/item-refund-orders/"/>" + this.itemOrderNumber + "\" target=\"_blank\">" +
                    itemImg +
                    "<div class=\"caption\">" +
                    "<p>" + this.title + "</p>" +
