...
<head>
    ...
    <title><fmt:message key="text.page.withdrawal.balance"/> - <fmt:message key="text.page.head.title"/></title>
...
<div class="container" role="main">
    ...
    <div class="col-sm-11 col-md-11 col-lg-11 page-header">
        <h1><fmt:message key="text.page.withdrawal.balance"/>
...
<script>
    ...
    /* 分页列表功能 */
    var pageHref = "<c:url value='/administrator/withdrawal-balance' />";
    ...
    function getListSuccessCallback(data, textStatus, jqXHR) {
        ...
        $.each(data.bills, function () {
            ...
            var $appendData = $("<div class=\"thumbnail img-cover\">" +
                    "<a href=\"<c:url value="/console/withdrawal-balance/"/>" + this.billId + "\" target=\"_blank\">" +
                    "<div class=\"caption\">" +
